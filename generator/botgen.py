...
def asJson(entry): return { 'unix_time' : asits(entry[0]), 'category_id': entry[1], 'ip' : entry[2], 'event' : entry[3] } 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--duration', type=int, default=600,   help="log duration in sec")
